...
class HICODetection(torch.utils.data.Dataset):
    ...
    def __init__(self, img_set, img_folder, anno_file, transforms, num_queries):
        ...
        self.word2vec_verb = np.load("data/hico_20160224_det/annotations/coco_clipvec_verb.npy")
           ...
           # pdb.set_trace()
            for hoi in img_anno['hoi_annotation']:
                ...
                if sub_obj_pair in sub_obj_pairs:
                    ...
                    verb_embs[sub_obj_pairs.index(sub_obj_pair)] = verb_embs[sub_obj_pairs.index(sub_obj_pair)]+self.word2vec_verb[verb_index]
                else:
